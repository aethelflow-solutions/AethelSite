...
export default function MediaCardServices({ data }: MediaCardProps) {
  ...
  return (
    <Card
      component="article"
      className="service-card"   // 👈 important for GSAP
      sx={{
        minHeight: 450,
        maxWidth: 400,
        bgcolor: "#F7F6FF",
    ...
    >
      ...
      >
        <Typography component="h3" variant="h5" fontWeight={600} fontSize="1.75rem">
          {data.title}
        </Typography>

        <Typography variant="body1" sx={{ opacity: 0.8 }} fontSize="16px">
          {data.description}
        </Typography>
      </Box>
